...
window.addEventListener("DOMContentLoaded", e => {
  ...
  function displayInstructions() {
    ...
    instructions.innerHTML =
      "You will have around 10-15 seconds of a movie clip played. <br> Your job is to click the answer of the movie title.  <br> Your score will be tallied up at the end.<br><br>";
